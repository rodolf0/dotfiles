" CRUSH syntax file
" Language:         CRUSH compiler input
" Maintainer:       Jeremy Hinds
" URL:              http://thcpelroy.doubleclick.net
" Last Change:      2008-06-06
"
" This is just a hybrid of the m4 and sh vim syntax files maintained by
" Claudio Fleiner and Dr. Charles E. Campbell, Jr., respectively.
...
syn region m4Function matchgroup=m4Type      start="\<[_A-Z][_A-Z0-9]*("he=e-1 end=")" contains=@m4Top,@shCommandSubList
syn region m4String   start="<++" end="++>" contained contains=@m4StringContents,SpellErrors
" syn region m4String   start="<++" end="++>" contained contains=@m4Top,@m4StringContents,SpellErrors
syn region m4String   start="\"" end="\""
syn region m4String   start="\'" end="\'"
" syn region m4String   start="\'" end="\'" contained contains=@m4Top,@m4StringContents,SpellErrors
...
let b:current_syntax = "crush"

if main_syntax == 'crush'
  unlet main_syntax
endif
